...
// ADDING A NEW ITEM TO THE LIST
  ...
  var addItem = function() {
    ...
    var nameCodigocargue = $("#nameCodigocargue").val();
    ...
    if (input) {
      ...
      fetch("https://desarrolloenviexpress.site/e-control/js/get_barcode_load.php?code=" + input + '&placa=' + namePlaca + '&codigo_cargue=' + nameCodigocargue + '&usuario=' + nameUsuario).then(response => {
