...
// ADDING A NEW ITEM TO THE LIST
  ...
  var addItem = function() {
    ...
    var placa = $("#placa").val();
    var estiba_inicio = $("#estiba_inicio").val();
    var cedi = $("#cedi").val();
    var tipo = $("#tipo").val();
    ...
    if (input) {
      ...
      fetch("https://desarrolloenviexpress.site/e-control/input_counting_in_house.php?nombre=" + input + '&mensaje=' + mensaje + '&placa=' + placa + '&estiba_inicio=' + estiba_inicio + '&cedi=' + cedi + '&tipo=' + tipo).then(response => {
