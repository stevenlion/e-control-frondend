...
// ADDING A NEW ITEM TO THE LIST
  ...
  var addItem = function() {
    ...
    var nameCodigoreenvio = $("#nameCodigoreenvio").val();
    ...
    if (input) {
      ...
      fetch("https://desarrolloenviexpress.site/e-control/js/get_reenvio.php?code=" + input + '&placa=' + namePlaca + '&codigo_reenvio=' + nameCodigoreenvio + '&usuario=' + nameUsuario).then(response => {
