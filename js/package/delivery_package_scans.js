...
// ADDING A NEW ITEM TO THE LIST
  ...
  var addItem = function() {
    ...
    if (input) {
      ...
      fetch("https://desarrolloenviexpress.site/e-control/ajax/package/delivery_package_scan.php?NameCodigoBarras=" + input + '&nameConsecutivo=' + nameConsecutivo + '&namePlaca=' + namePlaca + '&nameUsuario=' + nameUsuario ).then(response => {
