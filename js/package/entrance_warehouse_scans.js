...
// ADDING A NEW ITEM TO THE LIST
  ...
  var addItem = function() {
    ...
    if (input) {
      ...
      fetch("https://desarrolloenviexpress.site/e-control/ajax/package/entrance_warehouse_scan.php?NameCodigoBarras=" + input + '&nameConsecutivo=' + nameConsecutivo + '&nameUsuario=' + nameUsuario).then(response => {
