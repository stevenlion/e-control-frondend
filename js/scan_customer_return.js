...
// ADDING A NEW ITEM TO THE LIST
  ...
  var addItem = function() {
    ...
    if (input) {
      ...
      fetch("https://desarrolloenviexpress.site/e-control/js/get_customer_return.php?code=" + input + '&codigopk=' + nameCodigo + '&placa=' + namePlaca + '&usuario=' + nameUsuario).then(response => {
